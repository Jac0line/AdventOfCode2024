...
vector<tuple<int, int, int, int>> NumberProcessor::readRobotsFromFile(const string& filename) {
...
int NumberProcessor::calculateSafetyFactor(const vector<tuple<int, int, int, int>>& robots, int width, int height) {
    const int TIME = 100;
...
int NumberProcessor::findChristmasTree(vector<tuple<int, int, int, int>> robots, int width, int height) {
